"""
GeoTesseraZarr — read embeddings from a Tessera v2 zarr store.
...
class TesseraAccessor:
    """Tessera-aware methods on an xarray Dataset from a v2 zarr zone.
...
class GeoTesseraZarr:
    """Read embeddings from a Tessera v2 zarr store.
